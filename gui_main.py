...
class InvoiceSorterApp:
    ...
    def create_middle_section(self):
        ...
        start_btn = tk.Button(right_cell, text="🚀 분류 시작", bg="#999999", fg="#222222", font=("맑은 고딕", 12, "bold"), height=1, command=self.start_sorting)
    ...
    def start_sorting(self):
        ...
        try:
            ...
            if df is not None:
                ...
                if self.open_folder_var.get(): os.startfile(path)
